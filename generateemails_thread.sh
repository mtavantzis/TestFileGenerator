...
#cd /store/testdata/TestFileGenerator-0.7.3; 
start_date=$(date -d '60 days ago' +"%F %T"); end_date=$(date +"%F %T")
#perl ./test/construct.pl $1 /store/testdata/filepool $2
...
bash datagen.sh -params "date_start=$start_date;date_end=$end_date;" -c examples/$1
# > eml-perf-attach-pool_output.txt
